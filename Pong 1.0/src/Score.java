...
public class Score {
	...
	*/
	...
	public void draw(){
		...
		if(this.playerId.equals("Player 1")) GameLib.drawText(this.playerId + ": " + this.pontos, 70, GameLib.ALIGN_LEFT);
		if(this.playerId.equals("Player 2")) GameLib.drawText(this.playerId + ": " + this.pontos, 70, GameLib.ALIGN_RIGHT);	
	}
