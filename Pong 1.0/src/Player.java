...
public class Player {
	...
	*/
	...
	public void moveUp(long delta){
		...
		double distancia = this.speed * delta;

		if(this.cy - this.height/2 - distancia < this.v_limit[0]) {
			distancia = (this.cy - this.height/2) - this.v_limit[0];
		}
	...
	*/
	...
	public void moveDown(long delta){
		...
		if(this.cy + this.height/2 + distancia > this.v_limit[1]) {
			distancia = this.v_limit[1] - (this.cy + this.height/2);
		}
